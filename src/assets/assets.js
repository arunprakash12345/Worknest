...
export const dummyWorkspaces = [
  ...
  {
    id: "org_3",
    name: "Design Studio Lab",
    slug: "design-studio-lab",
    description: "Workspace for UI/UX, branding, and design systems projects.",
    settings: {},
    ownerId: "user_4",
    ...
    projects: [
      {
        ...
        description:
          "Complete redesign of a mobile banking experience with accessibility improvements.",
        priority: "HIGH",
        status: "ACTIVE",
        ...
        tasks: [
          {
            id: "task_1",
            projectId: "project_1",
            title: "Design Account Summary Screen",
            description:
              "Create mobile-friendly dashboard for account overview.",
            status: "COMPLETED",
            type: "FEATURE",
            priority: "HIGH",
            assigneeId: "user_4",
          ...
          },
          {
            ...
            description: "Check WCAG compliance across all screens.",
            status: "IN_PROGRESS",
            type: "IMPROVEMENT",
            priority: "MEDIUM",
            assigneeId: "user_5",
