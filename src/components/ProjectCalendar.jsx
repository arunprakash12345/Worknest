    ...
    <div className="grid lg:grid-cols-3 gap-6">
      ...
      <div className="lg:col-span-2">
        ...
        {getTasksForDate(selectedDate).length > 0 && (
          <div className="mt-6 not-dark:bg-white dark:bg-gradient-to-br dark:from-zinc-800/70 dark:to-zinc-900/50 border border-zinc-300 dark:border-zinc-800 rounded-lg p-4">
            ...
            <div className="space-y-3">
              {getTasksForDate(selectedDate).map((task) => (
                <Link
                  key={task._id}
                  to={`/batches/${task.batch}?tab=summary&taskId=${task._id}`}
                >
                  <div
                    className={`bg-zinc-50 dark:bg-zinc-800/40 hover:bg-zinc-100 dark:hover:bg-zinc-800 transition p-4 rounded border-l-4 cursor-pointer ${
            ...
            <div className="space-y-2">
              {upcomingTasks.map((task) => (
                <Link
                  ...
                  to={`/batches/${task.batch}?tab=summary&taskId=${task._id}`}
                >
                  <div className="bg-zinc-50 dark:bg-zinc-800/40 hover:bg-zinc-100 dark:hover:bg-zinc-800 p-3 rounded-lg transition cursor-pointer">
            ...
            <div className="space-y-2">
              {overdueTasks.slice(0, 5).map((task) => (
                <Link
                  ...
                  to={`/batches/${task.batch}?tab=summary&taskId=${task._id}`}
                >
                  <div className="bg-red-50 dark:bg-red-900/20 hover:bg-red-100 dark:hover:bg-red-900/30 p-3 rounded-lg transition cursor-pointer">
